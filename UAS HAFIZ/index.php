  ...
  <body>
    ...
    <nav class="navbar navbar-light bg-success object-fit-cover border rounded mt-3">
        <div class="container-fluid">
          <a class="navbar-brand"><img src="image/btminton.png " width="50" class="rounded float-start" alt=""></a>
    ...
    <div class="container">
      ...
      <h1>Selamat Datang diwebsite</h1>
      <h6>Pemain Badminton jambi</h6>
      <p>
      Bulu tangkis atau tepuk bulu adalah suatu olahraga yang menggunakan alat yang berbentuk bulat dengan memiliki rongga-rongga di bagian pemukulnya. Dan memiliki gagang. Alat ini dikenal dengan nama raket yang dimainkan oleh dua orang atau dua pasangan yang saling berlawanan.
      </p>
      <a href="login.php">
